...
@mcp.tool()
async def create_group(profile: dict, ctx: Context = None) -> dict:
...
@mcp.tool()
async def confirm_delete_group(group_id: str, confirmation: str, ctx: Context = None) -> dict:
...
@mcp.tool()
async def update_group(group_id: str, profile: dict, ctx: Context = None) -> dict:
...
@mcp.tool()
async def list_group_apps(group_id: str, ctx: Context = None) -> dict:
...
@mcp.tool()
async def add_user_to_group(group_id: str, user_id: str, ctx: Context = None) -> dict:
...
@mcp.tool()
async def remove_user_from_group(group_id: str, user_id: str, ctx: Context = None) -> dict:
